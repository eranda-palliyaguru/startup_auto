              ...
              <div class="tab-pane" id="settings">
                <form  method="post" action="profile_save.php" class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="email" value="<?php echo $email; ?>" id="inputName" placeholder="E-mail">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control"  name="vehicle_no" value="<?php echo $vehicle_no ;?>" id="inputEmail" placeholder="Vehicle No" required>
                    </div>
                  </div>
				  ...
				  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="chassis_no" value="<?php echo $chassis_no; ?>" id="inputName" placeholder="Chassis No">
