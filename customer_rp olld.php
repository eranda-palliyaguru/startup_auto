...
<link rel="stylesheet" href="datepicker.css"
 ...
 <script type="text/javascript">
  ...
  <!-- Content Wrapper. Contains page content -->
	...
	<a href="lon_print.php?d1=<?php echo $_GET['d1'];?>&d2=<?php echo $_GET['d2'];?>"><button  class="btn btn-info" style="width: 123px; height:35px; margin-top:-8px;margin-left:8px;" >
  Print
 </button></a>
		...
		$hh=date("Y/m/d");
			...
			?>
				...
				<td><?php echo $row['order_id'];?></td>
				  ...
				  <?php
				$result1 = $db->prepare("SELECT sum(amount) FROM sales WHERE   order_id='$ord' ");				
