...
<center>
 ...
 <label>	Vehicle Number</label>
                ...
                <input style="width:120px"  type="text" name="vehicle_no"  class="form-control" data-inputmask='"mask": "AAA-9999"' data-mask required>
                ...
                <input style="width:120px"  type="number" name="km"  class="form-control" data-mask required>
